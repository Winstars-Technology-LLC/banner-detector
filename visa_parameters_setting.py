...
def set_visa_parameters():
    ...
    detect_banner_color = {'h_params': {'low': 0.5, 'high': 1.5}, 's_params': {'low': 0, 'high': 255},
                           'v_params': {'low': 0, 'high': 255}}
    find_contour_coordinates = {'deviation': 0.1}
    ...
    function_list.extend([detect_contour_parameters, adjust_referee_colors_parameters, resize_banner_parameters,
                          detect_banner_color, find_contour_coordinates, adjust_logo_colour_parameters])
